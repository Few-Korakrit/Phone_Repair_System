<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="report_repair.ascx.cs" Inherits="ระบบแจ้งซ่อมมือถือ.View.report_repair" %>
...
<div class=" container-fluid">
    <div class="row mt-5 mb-54">
        ...
        <div class="col-8">
            <div class=" container-fluid">
                <h2 class=" text-center">รายงานข้อมูลแจ้งซ่อม</h2>
                <div class="row">
                    <div class="col">
                        <div class=" d-grid gap-2 d-md-flex justify-content-md-end mt-2">
                            <label for="txtStartDate" class="col-sm-2">ตั้งแต่วันที่:</label>
                    ...
                    <div class="col">
                        <div class="d-grid gap-2 d-md-flex justify-content-md-start mt-2">
                            <label for="txtEndDate" class="col-sm-2">ถึงวันที่:</label>
