<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="report_type.ascx.cs" Inherits="ระบบแจ้งซ่อมมือถือ.View.report_type" %>
...
<div class=" container-fluid">
    <div class="row mt-5 mb-54">
        ...
        <div class=" container-fluid">
            <h2 class=" text-center">รายงานข้อมูลประเภทสินค้า</h2>
            <form action="#">
                <div class="row">
                    <%--   <div class="col">
...
<script type="text/javascript">
    function printGridView() {
        ...
        // เพิ่มหัวข้อรายงาน
        newWin.document.write('<h1>รายงานข้อมูลประเภทสินค้า</h1>');
